        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="editPlay.op" >
...
<c:forEach items="${gioco}" begin="0" end="${fn:length(gioco) - 0}" var="index">

                            
                            <div class="form-group">
                                <label for="script" class="control-label col-md-3 col-sm-3 col-xs-12">Select Play Name <span class="required">*</span></label>
                                <div class="col-md-3 col-sm-5 col-xs-12">
                                    <input type="text" id="name" name="name" required="required" class="form-control col-md-7 col-xs-12" value="${index.nome}">
                            ...
                            <div class="form-group">
                                ...
                                <div id="editor1" class="editor-wrapper">${index.specifiche} </div>
                            ...
                            <div class="control-label col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div id="editor" class="editor-wrapper">${index.descrizione} </div>
